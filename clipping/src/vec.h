#ifndef MM_BASIC_VEC_H
#define MM_BASIC_VEC_H
...
namespace mm
{
    ...
    public:
        ...
        template <class T2>
        explicit Vec(const Vec<N, T2> &rhs)
        {
            for (size_t i = 0; i < N; i++)
            {
                data_[i] = T(rhs[i]);
        ...
        explicit Vec(const Vec<M, T2> &rhs)
        {
            assert(M == N);
            for (size_t i = 0; i < N; i++)
            {
    ...
    inline Vec<N, T> operator*(T2 s, const Vec<N, T> &v)
    {
        Vec<N, T> result;
        for (size_t i = 0; i < N; i++)
        {
    ...
    template <size_t N, class T>
    inline T length2(const Vec<N, T> &v)
    {
        return v.length2();
    }
    ...
    template <size_t N, class T>
    inline Vec<N, T> mix(const Vec<N, T> &v1, const Vec<N, T> &v2, T w)
    {
     ...
     * \tparam T The scalar type of vector elements.
     *
     * \class Vec<2, T> miemie/basic/vec.h
     */
    template <class T>
    class Vec<2, T>
    {
    public:
        ...
        {
        } // very useful for inverse promoting from homogeneous coordinates
        ...
        template <class T2>
        explicit Vec(const Vec<2, T2> &v)
            : x(v.x), y(v.y)
        {
        }

        template <class T2>
        explicit Vec(const T2 *v)
            : x(T(v[0])), y(T(v[1]))
        {
        }
    ...
    template <class T>
    inline T dot(const Vec<2, T> &v1, const Vec<2, T> &v2)
    {
    ...
    template <class T>
    inline T det(const Vec<2, T> &v1, const Vec<2, T> &v2)
    {
    ...
    /// The negative vector.
    template <class T>
    inline Vec<2, T> operator-(const Vec<2, T> &v1)
    {
    ...
    inline Vec<2, T> operator*(T2 s, const Vec<2, T> &v)
    {
     ...
     * \tparam T The scalar type of vector elements.
     *
     * \class Vec<3, T> miemie/basic/vec.h
     */
    template <class T>
    class Vec<3, T>
    {
    public:
        ...
        {
        } // very useful for promoting to homogeneous coordinates
        ...
        template <class T2>
        explicit Vec(const Vec<3, T2> &v) : x(v.x), y(v.y), z(v.z)
        {
        }
    ...
    template <class T>
    inline T dot(const Vec<3, T> &v1, const Vec<3, T> &v2)
    {
    ...
    /// The negative vector.
    template <class T>
    inline Vec<3, T> operator-(const Vec<3, T> &v1)
    {
        return Vec<3, T>(-v1.x, -v1.y, -v1.z);
    }

    /// Scalar-vector multiplication.
    template <class T2, class T>
    inline Vec<3, T> operator*(T2 s, const Vec<3, T> &v)
    {
    ...
    template <class T>
    inline Vec<3, T> orthogonal(const Vec<3, T> &v)
    {
        T absx = std::fabs(v.x);
        T absy = std::fabs(v.y);
        T absz = std::fabs(v.z);
     ...
     * \tparam T The scalar type of vector elements.
     *
     * \class Vec<4, T> miemie/basic/vec.h
     */
    template <class T>
    class Vec<4, T>
    {
    ...
    template <class T>
    inline T dot(const Vec<4, T> &v1, const Vec<4, T> &v2)
    {
    ...
    /// The negative vector.
    template <class T>
    inline Vec<4, T> operator-(const Vec<4, T> &v1)
    {
        return Vec<4, T>(-v1.x, -v1.y, -v1.z, -v1.w);
    }

    /// Scalar-vector multiplication.
    template <class T2, class T>
    inline Vec<4, T> operator*(T2 s, const Vec<4, T> &v)
    {
    ...
    template <size_t N, class T>
    inline std::istream &operator>>(std::istream &in, Vec<N, T> &v)
    {
        for (size_t i = 0; i < N; i++)
        {
            in >> v[i];
    ...
    template <class T>
    inline std::ostream &operator<<(std::ostream &out, const Vec<2, T> &v)
    {
        return out << v.x << " " << v.y;
    }
    ...
    template <class T>
    inline std::istream &operator>>(std::istream &in, Vec<2, T> &v)
    {
        return in >> v.x >> v.y;
    }
    ...
    template <class T>
    inline std::istream &operator>>(std::istream &in, Vec<3, T> &v)
    {
    ...
    template <class T>
    inline std::ostream &operator<<(std::ostream &out, const Vec<4, T> &v)
    {
    ...
    template <class T>
    inline std::istream &operator>>(std::istream &in, Vec<4, T> &v)
    {
    ...
    inline Vec<N, T> clamp(const Vec<N, T> &a, const Vec<N, T> &lower, const Vec<N, T> &upper)
    {
        Vec<N, T> result;
        for (unsigned int i = 0; i < N; ++i)
            result[i] = std::min(upper[i], std::max(a[i], lower[i]));
        return result;
    }

...
#ifndef MM_BASIC_BOX_H
#define MM_BASIC_BOX_H
...
namespace mm
{
     ...
     * \class GenericBox miemie/basic/box.h
    ...
    public:
        ...
        inline Vector diagonal_vector() const
        {
            return max_ - min_;
        }

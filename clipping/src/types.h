...
namespace mm
{
    ...
    typedef GenericBox<2, double> Box2;
    /// \brief A 3D axis-aligned bounding box of \p float type.
    typedef GenericBox<3, double> Box3;

    /// @brief A 2D pollygon of \p double type;
    typedef GenericPolygon<double> Polygon2;
    typedef ShpPolygon<double> ShpPolygon2;
    /// Is this NaN?
